...
import { ChatbotService, ChatHistoryItem } from '../../services/chatbot/chatbot.service';
...
export class ChatbotComponent {
  ...
  public pdfIcon: string = `<svg width="40px" height="40px" viewBox="-4 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  constructor(
    ...
    this.pdfIconSafe = this.sanitizer.bypassSecurityTrustHtml(this.pdfIcon);
  }
  ngOnInit(): void {
    this.loadHistory();
  }

  /** 📜 گرفتن تاریخچه از سرور */
  loadHistory(): void {
